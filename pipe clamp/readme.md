This is a clean, structured version of your Configuration & Parameters section for a GitHub README.md. I have formatted it using Markdown tables and lists to make it look professional and easy for others to read.
...
show_logo	Displays the logo as a solid object (for alignment or multi-material setup).
show_ref_rod	Shows a transparent rod to visualize the fit of the clamp.
2. Main Geometry
    ...
    gap: The distance between the two halves. This allows the bolts to tighten the clamp onto the rod.
